...
async function extractChildren(nodes) {
  const children = [];
...
async function generateNewComponent(componentType, properties) {
  try {
    let newNode;
...
async function createButton(properties) {
...
async function createInput(properties) {
...
async function createCard(properties) {

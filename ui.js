...
document.addEventListener('DOMContentLoaded', () => {
  // Get DOM elements
  const readComponentsBtn = document.getElementById('read-components');
  ...
  const cardProperties = document.getElementById('card-properties');
  const buttonTextInput = document.getElementById('button-text');
  const inputPlaceholderInput = document.getElementById('input-placeholder');
  ...
  // Display code output
  function displayCodeOutput(codeData) {
